...
- [x] 1.1 Walk every entry under "Accepted decisions" and record its
...
- [x] 1.2 For each entry marked **deleted**, open the archived change and
...
- [x] 1.3 For each entry marked **fence**, check whether the comment already
...
- [x] 1.4 Leave the standing constraints — Preact, camelCase in every JSON
...
- [x] 1.5 Collapse the completed queue entries to one line naming the archive,
...
- [x] 1.6 Add `PLAN.md`'s growth protocol: what lives there, what evicts an
      ...
      three routes*
- [x] 1.7 Restate the `CLAUDE.md` trigger in *Structure & growth of this file*
...
- [x] 1.8 Reconcile every site restating what this step changes: `README.md`'s
...
- [x] 1.9 Record the before and after line counts of both files in the PR body,
      so the next maintenance run has a figure to compare against
- [x] 1.10 Do not add a CI check on the line counts — the trigger is a
