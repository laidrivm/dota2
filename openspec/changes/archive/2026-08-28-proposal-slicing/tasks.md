...
- [x] 1.1 Write the refusal tests: an unsplit proposal over the threshold with
      ...
      branch)
- [x] 1.2 Write the tests for what the refusal must not reach: a branch adding
...
- [x] 1.3 Write the tests for what counts as authoring a proposal: an archive
...
- [x] 1.4 Write the gate-line tests: the refused line names both branches of
      ...
      override does not admit an unsplit propose-stage branch)
- [x] 1.5 Write the artefact-pair tests: a proposal carrying all four artefacts
      ...
      pair)
- [x] 1.6 Implement the detection in `scripts/diff-budget.sh`: the additions of
...
- [x] 1.7 Implement the refusal and its gate line, so an unsplit propose-stage
      ...
      The override does not admit an unsplit propose-stage branch)
- [x] 1.8 Reconcile the two docs with the mechanism, each in the direction it
