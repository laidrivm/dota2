 ...
 * production pipeline short of minification, so a defect the bundler
 * introduces is under test here rather than only in `build.test.ts`.
 * `/snapshot.json` and the fonts keep their own routes and are served from
 * source either way.
 *
